...
struct SettingsView: View {
    ...
    private var settingsSearchIndex: [SettingsSearchEntry] {
        [
            ...
            SettingsSearchEntry(tab: .lockScreen, title: "Show AirPods case battery", keywords: ["airpods", "case", "charging case", "bluetooth", "battery"], highlightID: SettingsTab.lockScreen.highlightID(for: "Show AirPods case battery")),
            ...
            SettingsSearchEntry(tab: .lockScreen, title: "Hide focus label", keywords: ["focus", "icon", "label", "lockscreen"], highlightID: SettingsTab.lockScreen.highlightID(for: "Hide focus label")),
            SettingsSearchEntry(tab: .lockScreen, title: "Show focus above weather", keywords: ["focus", "weather", "order", "above", "lock screen"], highlightID: SettingsTab.lockScreen.highlightID(for: "Show focus above weather")),
    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Defaults.Toggle("Show focus above weather", key: .lockScreenShowFocusAboveWeather)
                    .disabled(!enableLockScreenFocusWidget)
                    .settingsHighlight(id: highlightID("Show focus above weather"))
                
            } header: {
                Text("Focus Widget")
            } footer: {
                Text("Displays the current Focus state below the weather capsule whenever Focus detection is enabled.")
            }
