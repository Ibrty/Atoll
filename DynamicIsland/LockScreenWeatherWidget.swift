...
struct LockScreenWeatherWidget: View {
    ...
    @Default(.lockScreenShowFocusAboveWeather) private var lockScreenShowFocusAboveWeather
	...
	var body: some View {
        VStack(alignment: .center, spacing: focusWidgetSpacing) {
            if lockScreenShowFocusAboveWeather {
                focusWidget
    ...
    private func bluetoothDevicesSegment() -> some View {
        let devices = bluetoothManager.connectedDevices
